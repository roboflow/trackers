...
<!-- BENCH-XREF copy-of: docs/benchmarking/results.md BoT-SORT row in mot17-default/sportsmot-default/soccernet-default tables. Also duplicated in docs/index.md (Algorithms table), README.md (Algorithms table), and docs/trackers/mcbyte.md (BoT-SORT baseline row, matching tab per benchmark). No DanceTrack row here by design. Update results.md first, then mirror here. -->
