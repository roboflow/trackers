...
<!-- BENCH-XREF copy-of: [docs/evaluations/results.md](docs/evaluations/results.md) mot17/sportsmot/soccernet/dancetrack-default tables, HOTA column only, all 6 rows (SORT/ByteTrack/OC-SORT/BoT-SORT/C-BIoU/McByte). Also duplicated in [docs/index.md](docs/index.md)'s Algorithms table (all 6 rows) and [.github/copilot-instructions.md](.github/copilot-instructions.md)'s Benchmark Results table (still omits C-BIoU — not updated in this pass). Update results.md first, then mirror all three copies. -->
