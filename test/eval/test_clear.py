...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            [np.array([[0.9]]), np.array([[0.85]]), np.array([[0.8]]),
             np.array([[0.75]])],
            0.5,
        ...
        (
            [np.array([0]), np.array([0]), np.array([0]), np.array([0]),
             np.array([0])],
            [np.array([1]), np.array([]), np.array([1]), np.array([]),
             np.array([1])],
            [np.array([[0.9]]), np.empty((1, 0)), np.array([[0.85]]),
             np.empty((1, 0)), np.array([[0.8]])],
            0.5,
        ...
        (
            ...
            [
                np.array([[0.9]]), np.array([[0.9]]), np.array([[0.9]]),
                np.array([[0.9]]), np.array([[0.9]]), np.array([[0.9]]),
                np.array([[0.9]]), np.array([[0.9]]),
                np.empty((1, 0)), np.empty((1, 0)),
            ],
            0.5,
            {"MT": 0, "PT": 1, "ML": 0},
        ),
        ...
        (
            ...
            [
                np.array([1]), np.array([1]), np.array([]), np.array([]),
                np.array([]), np.array([]), np.array([]), np.array([]),
                np.array([]), np.array([]),
            ],
            [
                np.array([[0.9]]), np.array([[0.9]]),
                np.empty((1, 0)), np.empty((1, 0)), np.empty((1, 0)),
                np.empty((1, 0)), np.empty((1, 0)), np.empty((1, 0)),
                np.empty((1, 0)), np.empty((1, 0)),
            ],
            0.5,
