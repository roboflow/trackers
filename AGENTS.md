...
<!--
BENCH-XREF MAP — canonical source: [docs/evaluations/results.md](docs/evaluations/results.md) (Default + Tuned tables per benchmark section).
...
C-BIoU row (mot17/sportsmot/soccernet/dancetrack — the only tracker doc with a DanceTrack row):
  -> [docs/trackers/cbiou.md](docs/trackers/cbiou.md)          (table, full row, all 4 benchmarks)
  -> [README.md](README.md)                                    (Algorithms table, HOTA column only)
...
McByte row (mot17/sportsmot/soccernet/dancetrack):
  -> [docs/trackers/mcbyte.md](docs/trackers/mcbyte.md)        (McByte row, matching benchmark tab, full row)
  -> [docs/index.md](docs/index.md) FAQ "Which tracker should I use?" answer: "McByte leads every benchmark in our evaluation"
...
- [docs/index.md](docs/index.md) FAQ: "McByte leads every benchmark in our evaluation" (needs McByte = best in all 4 Default tables)
- [docs/evaluations/results.md](docs/evaluations/results.md) "When to Use Each Tracker" section: multiple leader/ranking claims
...
[docs/evaluations/results.md](docs/evaluations/results.md) states "Results use trackers vX.Y.Z" (currently v2.6.0) — must be bumped whenever
...
[docs/evaluations/results.md](docs/evaluations/results.md) on 2026-08-11 to match the mkdocs nav tab name ("Evaluations"),
