...
| `reid_emb_dist_threshold`                 | Appearance distance gate θ_emb (halved cosine distance cap).                  | Default `0.25` (BoT-SORT `appearance_thresh`). On MOT17 with a MOT-trained encoder, `0.2` often works better ([SCCAI 2025](https://www-sop.inria.fr/members/Francois.Bremond/Postscript/Tomasz__SCCAI_2025.pdf)). Increase to allow more appearance matches.                                                                                                                                                            |
| `reid_iou_dist_threshold`                 | IoU distance gate θ_iou before appearance is used for active tracks.          | Default `0.5` (`proximity_thresh`; IoU > 0.5). Increase to loosen proximity gating.                                                                                                                                                                        |
