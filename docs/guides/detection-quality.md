...
Download the MOT17 validation split (frames for detection, annotations for evaluation) — see the [download guide](../evaluations/download.md) for the full command and available options.
