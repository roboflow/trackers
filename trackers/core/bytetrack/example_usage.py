...
tracker = ByteTrackTracker(minimum_consecutive_frames=3, feature_extractor =feature_extractor ,lost_track_buffer=100)
...
SOURCE_VIDEO_PATH = "<path-to-your-video>.mp4" #eg: SOURCE_VIDEO_PATH = "traffic_video_1.mp4"
